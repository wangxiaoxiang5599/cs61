...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    a = player_score % 10 - opponent_score % 10
    # 获取a的绝对值
    if a < 0:
        a = -a
    # 获取opponent_score的十位数, 去掉百位之上的数
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while True:
        ...
        if who == 0:
            ...
            if feral_hogs:
                if abs(num_rolls - last_turn_score0) == 2:
                    score0 += 3
            ...
            if feral_hogs:
                if abs(num_rolls - last_turn_score1) == 2:
                    score1 += 3
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    gain = free_bacon(opponent_score)
    score += gain
    if gain >= cutoff and not is_swap(score, opponent_score):
        return 0
